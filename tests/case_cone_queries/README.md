...
- Q8's mention of `DFF_OUT_FF1` is the canonical name for the virtual node test system uses; a system that names it `q1` (the actual q signal of FF1) is also acceptable.
