...
6. Remove floating nodes that do not affect outputs. Make sure nothing changes functionally.
...
11. Please write the current design to the output file test30_out.v.
