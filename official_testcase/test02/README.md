# test02 — official 0510 release

**Source**: Cadence Design Systems, official release 2026-05-10.
**Netlist**: `test02.v` (12637 lines)

## Prompts

1. This is the beginning of a new testcase. The case name is test02.
2. Please load the design from the file test02.v located in the directory testcase/test02/.
...
4. Please write the current design to the output file test02_out.v.
